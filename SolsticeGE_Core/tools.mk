...
SHADERC:="$(THISDIR)../vcpkg_installed/x64-$(OS)/x64-$(OS)/tools/bgfx/shaderc"
GEOMETRYC:="$(THISDIR)../vcpkg_installed/x64-$(OS)/x64-$(OS)/tools/bgfx/geometryc"
TEXTUREC:="$(THISDIR)../vcpkg_installed/x64-$(OS)/x64-$(OS)/tools/bgfx/texturec"