...
namespace CPM_GLM_AABB_NS {
    ...
    public:
        ...
        AABB(const glm::vec3& center, glm::float32_t radius);
        ...
        void extend(const glm::vec3& center, glm::float32_t radius);
        ...
        glm::float32_t getLongestEdge() const;

        /// Retrieves the shortest edge.
        /// If the AABB is NULL, then 0 is returned.
        glm::float32_t getShortestEdge() const;
